 ...
 */
class Role extends \SamUser\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'roleId', 'parent');
        }
     ...
     * {@inheritDoc}
     */
    public function setParent(\SamUser\Entity\Role $parent)
    {
